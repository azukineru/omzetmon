          ...
          <div class="row medium-12">
            <div class="inner">
              ...
              <ol>
                ...
                <p>
                  Simply click Admin Management on the left sidebar. After that you will see a table which contain user(s) who have requested a registration.
                </p>
                <li>I want to change my password or my phone number, how am I supposed to do ?</li>
                <p>
                  Click 'Settings' button on the top-right side, you will be able to see form. Fill the field that you want to change and click 'Save'.
                </p>
              </ol>
            </div>
          </div>
