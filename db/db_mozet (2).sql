...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2017 at 03:46 AM
...
--
-- Dumping data for table `tb_unsigned`
--

INSERT INTO `tb_unsigned` (`email`, `password`, `fname`, `lname`, `phone`, `acctype`, `sto`) VALUES
('lala@lulu.com', 'a1d123a63936abbee87823e2f1affa9b', 'lulu', 'lala', '021', 'provisioning', ''),
('lulu@lala.com', '14a67fc184d1749bf067f6d4f23d651a', 'Lala', 'lulu', '021', 'provisioning', '');
