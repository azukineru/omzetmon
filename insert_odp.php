...
<head>
  ...
  <title>OM-OM | Inserting Data OMZET DP/ODP</title>
        ...
        <div class="row large-12">
          ...
          if (isset($_POST["save"])) {
           if((isset($_POST['no_telp']) && ctype_digit($_POST['no_telp'])) || (isset($_POST['no_internet']) && ctype_digit($_POST['no_internet']))){
            insertData(3,$_POST['sto'],$_POST['no_telp'],$_POST['no_internet'],$_POST['qr'],$_POST['data_lama'],$_POST['data_baru'],$_POST['keterangan'],$login_email);
          }else{
            echo
            '<script>
